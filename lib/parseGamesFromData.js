function parseGamesFromData(rawData, sportName = "Unknown") {
    ...
    const pushGame = (game, regionName, competitionName, competitionData = {}) => {
        const markets = {};
        if (game.market) {
        ...
        for (const regionId in data.region) {
            ...
            for (const competition of competitions) {
                ...
                for (const game of games) {
                    pushGame(game, region?.name || regionId, competition?.name, competition);
                }
            }
        }
    }
            ...
            if (sport?.region) {
                ...
                for (const region of regions) {
                    ...
                    for (const competition of competitions) {
                        ...
                        for (const game of games) {
                            pushGame(game, region?.name, competition?.name, competition);
                        }
                    }
                }
